...
def logging_table(table_list: list, val_list: list, test_list: list):
    table = PrettyTable([" "] + table_list)
    table.add_row(["val_acc"] + val_list)
    table.add_row(["test_acc"] + test_list)
    table.add_row([" "] + [round(val_list[i]+test_list[i], 2) for i in range(len(table_list))])
...
if __name__ == '__main__':
    result_table = logging_table(list(range(0, 20)), list(range(0, 20)), list(range(0, 20)))
    print(result_table)
