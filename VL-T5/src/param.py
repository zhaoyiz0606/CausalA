...
def parse_args(parse=True, **optional_kwargs):
    ...
    #####
    parser.add_argument("--size_txt", type=int, default=25)
    parser.add_argument("--losses", default='lm,itm', type=str)
    parser.add_argument("--losses_weight", type=json.loads, default={"vqa": 1, "lm": 0.1, "itm": 0.1, "vg": 0.4})

    #####adapter
    parser.add_argument("--bert_type", type=str, default='ft')
    parser.add_argument("--cross_type", type=str, default='g2g')
    parser.add_argument("--ft_large",action='store_true')
    parser.add_argument("--num_l_layers", type=int, default=1)
    parser.add_argument("--num_r_layers", type=int, default=0)
    parser.add_argument("--num_x_layers", type=int, default=0)
    parser.add_argument("--MV_size", type=int, default=100)
    parser.add_argument("--ML_size", type=int, default=100)
